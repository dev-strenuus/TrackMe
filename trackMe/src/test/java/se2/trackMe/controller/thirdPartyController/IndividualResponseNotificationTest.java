...
@DirtiesContext
public class IndividualResponseNotificationTest {
     ...
     */
    @Test
    public void IndividualResponseNotificationTest() {
        ...
        assertEquals(thirdPartyService.getIndividualRequestNotificationList(thirdParty).get(0).getAccepted(),true);
    }
}
