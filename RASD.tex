...
\newpage
	\begin{legal}\bfseries
 	\item Introduction \\
		...
		\\
		{\normalfont
		This purpose of this Requirement Analysis and Specification Document (RASD) is to provide a detailed description of the TrackMe system.\\ 
		The document is addressed to the development team who has to implement the whole system and it could be used as a contractual basis.
		}\\
		\item Scope\\
			\begin{legal}
    		\item Description of the system \\
			{\normalfont
The TrackMe system is a mobile application that is actually made up by three different modules:\\
- Data4Help;\\
- AutomatedSOS;\\
- Track4Run.\\
Data4Help is a service that allows third parties to monitor the location and health status of individuals. TrackMe acquires data of registered users trough external devices connected to the users' smartphones.\\
The other two services are built on top of Data4Help to provide tangible functionalities for the users.\\
AutomatedSOS is an optional service that monitors the health status of users by performing a continous evalution of the health parameters' data acquired by Data4Help. It sends an SOS to an entity that can send an ambulance to the location of the user if it establishes that the user is in danger.\\
Track4Run is a service thought for the organization of running events. It permits to third parties to organize events and to users to enroll to them or simply to know the position of runners during a race.\\
	...
	\item Specific requirements\\
		...
		\item External interface requirements\\
			...
			\item Activity Diagram
				\begin{figure}[H]
  				\includegraphics[width=\linewidth]{./images/Join-a-run-activity-diag.png}
				\end{figure}
